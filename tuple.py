...
#To insert we have to do wrkaround=> first we convert tuple into list and then back into tuple.
fruitsl=list(fruits)
fruitsl.insert(2,"Orange")
fruitst=tuple(fruitsl)
# print(fruitst)
...
x=(1,2,3)
y=(4,5,*x,6)#'*' unpacks the values of x
# print(y)
